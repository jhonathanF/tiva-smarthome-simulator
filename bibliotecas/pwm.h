...
void setGeneratorA(int pwmModule, int element, uint32_t mode); //Nivel baixo em LOAD / Nivel alto em CMPA
void setGeneratorB(int pwmModule, int element, uint32_t mode); //Nivel baixo em LOAD / Nivel alto em CMPA
...
void setCmpb(int pwmModule, int element, uint32_t frequencia, uint32_t porcentagem);
...
void configurarPWM(int cmp, int pwmModule, int element, uint32_t mode, uint32_t frequencia, uint32_t porcentagem,  uint32_t ctl);
